  ...
  return (
    <>
      <header
        ...
        style={{ backgroundColor: 'var(--owf-surface)', borderBottom: '1px solid var(--owf-border)' }}
      >
        <div className="flex items-center justify-between px-4 h-14">

          {/* Logo */}
          <div className="flex items-center gap-2 flex-shrink-0">
            <Image src="/owf-logo.png" alt="OneWorldFeed" width={36} height={36} className="rounded-full" />
          ...
          <div className="flex-1 max-w-sm mx-4">
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm" style={{ color: 'var(--owf-text-secondary)' }}>⌕</span>
              <input type="text" placeholder="Search people, +tags, cities..."
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button
              ...
              className="text-white text-sm font-semibold px-4 py-1.5 rounded-full transition-all hover:scale-105 active:scale-95"
