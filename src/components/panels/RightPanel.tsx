...
const THEMES = [
  { id: 'dawn',     label: 'Dawn',     gradient: 'linear-gradient(135deg, #FBEAFF, #FFD6E0, #FFB347)', vars: { '--owf-bg': '#FDF6FF', '--owf-surface': '#FFF0FA', '--owf-border': '#F0D6E8', '--owf-text-primary': '#2D1B3D', '--owf-text-secondary': '#8B5A7A', '--owf-navy': '#2D1B3D', '--owf-accent': '#C0527A', '--owf-gold': '#C0527A', '--owf-glow': 'rgba(192,82,122,0.28)', '--owf-card-glow': 'rgba(192,82,122,0.07)' } },
  ...
  { id: 'forest',   label: 'Forest',   gradient: 'linear-gradient(135deg, #0A2E0A, #1B5E20, #4CAF50)', vars: { '--owf-bg': '#020F02', '--owf-surface': '#071407', '--owf-border': '#102810', '--owf-text-primary': '#E8FFE8', '--owf-text-secondary': '#4A8A4A', '--owf-navy': '#102810', '--owf-accent': '#4CAF50', '--owf-gold': '#4CAF50', '--owf-glow': 'rgba(76,175,80,0.28)', '--owf-card-glow': 'rgba(76,175,80,0.07)' } },
